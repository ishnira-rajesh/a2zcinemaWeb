...
<script src="static/js/profilecontroller/profile_service.js"></script>
<script src="static/js/profilecontroller/profile_controller.js"></script>
...
<script type="text/javascript"
	src="static/js/angular-file-upload.min.js"></script>
...
<body ng-app="profileApp">
			...
			<div class="panel panel-success">
				<div class="row">
					<div class="col-lg-12">
									...
									<fieldset ng-if="ctrl.profiledata.length == 0">
										...
										<div class="form-group has-feedback"
											...
											<label for="" class="text-muted col-lg-4">Age<span
												...
												maxlength="4" ng-model="ctrl.profile.age" required
									...
									<fieldset ng-if="ctrl.profiledata.length !=0"
										...
										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-4">Date of
												...
												class="form-control-text" placeholder="DD-MM-YYYY"
												ng-model="ctrl.profile.dob" ng-init="ctrl.profile.dob=u.dob"
												required autocomplete="off" />
											<!-- <label style="color: red" class="text-muted col-lg-2">DD-MM-YYYY</label> -->
										</div>
						...
						<div class="col-lg-6">
							<div class="panel panel-default" id="createPhysicaldiv">
								...
								<form name="userPhyDetailsForm"
									...
									<fieldset ng-if="ctrlPhy.phydata.length == 0">
										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-2 ">Complexion<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.complexion"
											...
											</select> <label for="" class="text-muted col-lg-2">SkinQuality<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.skinQuality"
										...
										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-2 ">Eye Color<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.eyeColor"
											...
											</select> <label for="" class="text-muted col-lg-2">Height<span
												style="color: red">*</span></label> <input
												ng-model="ctrlPhy.phydetails.heightUnit" name="heightUnit"
												class="form-control-width col-lg-3"
												placeholder="Height (cm/feet)" required minlength="2"
												maxlength="50" autocomplete="off">
										</div>

										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-2 ">Weight<span
												style="color: red">*</span></label> <input
												ng-model="ctrlPhy.phydetails.weightUnit" name="weightUnit"
												class="form-control-width col-lg-3"
												placeholder="Weight (kg)" required minlength="2"
												maxlength="50" autocomplete="off" required> <label
												for="" class="text-muted col-lg-2">Physique<span
												style="color: red">*</span></label> <select
										...
										<div class="form-group has-feedback">
											...
											</label> <select ng-model="ctrlPhy.phydetails.facialHair"
											...
											</select> <label for="" class="text-muted col-lg-2">Hair Style<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.hairStyle"
										...
										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-2 ">Hair Color<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.hairColor"
											...
											</label> <select ng-model="ctrlPhy.phydetails.hairLength"
									...
									<fieldset ng-if="ctrlPhy.phydata.length !=0"
										...
										<input type="hidden" name="physicalDetailId"
											ng-model="ctrlPhy.phydetails.physicalDetailId"
											ng-init="ctrlPhy.phydetails.physicalDetailId=u.physical_details_id" />
										...
										<div class="form-group has-feedback">
											<label for="" class="text-muted col-lg-2 ">Weight<span
												...
												placeholder="Weight(kg)" required minlength="2"
												maxlength="50" autocomplete="off"> <label for=""
												class="text-muted col-lg-2">Physique<span
												style="color: red">*</span></label> <select
												ng-model="ctrlPhy.phydetails.physique"
										...
										<div class="progress col-md-5">
											<span>
												<div class="progress-bar" role="progressbar" 
													...
													aria-valuemax="100" style="background-color: #ff902b; width: {{">{{
							...
							<div class="panel panel-default" id="createVideodiv">
	...
	<!-- <div id="ChangeProfilePicModal" class="modal width25 fade in" role="dialog" data-backdrop="static" data-keyboard="false" aria-hidden="false" style="display: block; padding-right: 17px;">
	<div class="modal-dialog">
		<div class="modal-content no-padding">  style="width: 290px;"
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h4 class="modal-title">Upload Cover Picture </h4>
			</div>
			<div style="line-height: 5;">
			<button type="button" class="btn btn-info ladda-button ml42" data-style="zoom-in" id="defaultdashboradCoverPic">Default Pic</button>
			<button type="button" class="btn btn-success ladda-button ml42" data-style="zoom-in" id="changedashboardCoverImage">Upload Pic</button>
			</div>
			<div class="modal-footer">
	...
	<div class="modal fade width25" id="ChangeProfilePicModal"
		...
		<div class="modal-dialog" id="ChangeProfilePicFormdiv" >
			<div class="modal-content" ng-controller="UploadUserPicController" style="width: 290px;">
				...
				<div style="margin-left: 10px; margin-top: 10px;"><span>Please upload image of size (200*250) or more.</sapn></div>
