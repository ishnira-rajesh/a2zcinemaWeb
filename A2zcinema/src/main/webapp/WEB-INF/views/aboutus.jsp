		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default " style="height: 400px">
					<h4>A2zcinemaworld.com is a single window solutions provider for all kinds of filmy needs and it also aims to render a platform for all the talented artists and to the public to make their career in the film industry.</h4>
					</br> </br>
					<p>Stay tuned to www.a2zcinemaworld.com for exclusive updates on Auditions, Crowd Funding, Online Movie Distribution Teaser/Audio/Movie Releases/movie tickets booking, Gossips, Reviews, Reality Shows, Modelling, Interviews, and other movies stuffs.</p>
					</br> </br>
