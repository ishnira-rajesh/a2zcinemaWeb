	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default">
					<h4>
						Do you have an Idea OR got Ideas to make movies? We are here to provide you the complete movie script, which is nothing but a written work to execute / convert it to the visual display on the screens. It is crucial to remember that film is a VISUAL medium. You don't tell your audience your story, you SHOW them.</br></br>
						A2zcinemaworld.com&apos;s script Team consists of Screenplay writers, Dialogue writers, Eminent Directors, Story Writers, Cinematographers (Cameraman), Choreographers and selective public including media friends to take their opinion for the best outcome.
					</h4>
					</br>

					<p>A screenplay or script is a written work by screenwriters for a film, video game, or television program. These screenplays can be original works or adaptations from existing pieces of writing. In them, the movement, actions, expression, and dialogues of the characters are also narrated..</p>
					</br>
