	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						Our Poster/Banner Design Team has over 2 years experience in the film industry creating film posters and banners and has also created many more general posters as per customer customization.  </br> </br>
						No matter what your design need we have you covered and offer a range of packages designed to suit your need and fit your budgets.
					</h4>
					</br>
