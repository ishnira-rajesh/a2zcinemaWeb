...
<script src="static/js/email/email.js"></script>
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default">
				...
				<div class="col-lg-12 panel panel-default  ">
					<br>
					<h4>
						Want to make your movies through <strong>crowd funding?</strong>
					</h4>
					<p>
						A2zcinemaworld.com provides you the platform through MobileApp and
						Website for you now and forever. Just a single click takes you
						online registration process and uploading your personal and
						professional details.</br> For good featured movies along with a good
						story, a script and plans, production budget also plays a vital
						role and getting money invested from public through Crowd funding
						method in movie making is other amazing job.</br> Anyone and everybody
						can become PUBLIC- PRODUCERS by investing the money starting from
						1 lakh OR more on their capability and can make money.
					</p>
					<p>
						<strong>Note:</strong> Crowd funding (a form of crowd sourcing) is
						...
						which has emerged outside of the traditional financial system.
					</p>
					<h5>
						For any queries, whatsapp us on 9740200366 <i
							class="fa fa-whatsapp fa-2x" aria-hidden="true"
							style="color: #27c24c"></i> for immediate solutions.
					</h5>
				</div>


				<div class="col-lg-12 panel panel-default" ng-controller="CrowfundController as ctrl">
					<div class="panel-heading">
						<span class="lead">List of Movies </span>
					</div>
					<div class="col-lg-12 panel panel-default"
						...
						<table
							...
							<thead>
								<tr>
									<th>Movie<span style="color: #fff;">_</span>Name
									</th>
									<th>Director<span style="color: #fff;">_</span>Name
									</th>
									<th>Production<span style="color: #fff;">_</span>House<span
										style="color: #fff;">_</span></th>
									<th>Producers</th>
									<th>Star<span style="color: #fff;">_</span>Casts
									</th>
									<th>Movie<span style="color: #fff;">_</span>Budge
									</th>
									<th>Appealed<span style="color: #fff;">_</span>Amount
									</th>
									<th>Remaining<span style="color: #fff;">_</span>Amount
									</th>
									<th>Still<span style="color: #fff;">_</span>Need
									</th>
									<th>Status</th>
							...
							<tbody style="font-size: 13px;">
								<tr ng-repeat="u in ctrl.users">
									...
									<td><button type="submit" class="btn btn-success "
									    style="padding: 3px 3px 3px 3px;" title="make payment">
										<a style="color: #fff;" class="fa fa-inr">&nbsp;Pay</a>
										</button></td>
									<td><a href="#" data-toggle="modal" data-ng-click="contctEmail(u.crowd_funding_id);" data-target="#myModal"><i
											class="fa fa-envelope-o  fa-2x" style="color: #5d9cec;" title="Contact Email"></i></a></td>	
								</tr>
							</tbody>
						</table>
					</div>
								...
								<div class="modal-body">
                                      <form name="contactForm"  ng-submit="ctrl.save();">
						                      <div class="form-group has-feedback" ng-repeat="u in ctrl.movie">
						                        <input type="hidden" class="form-control-text"  ng-model="ctrl.contEmail.mDataId" ng-init="ctrl.contEmail.mDataId=u.crowd_funding_id">  
											   
											   <label class="text-muted">Movie Name :</label>
											   <label>{{u.movie_name}}</label>  
											   
											   <br><label class="text-muted">Director Name :</label> 
											   <label>{{u.director_name}}</label>  
											   
											   <br><label class="text-muted">Production House :</label> 
											   <label>{{u.pro_house_name}}</label>  
											   
											   <br><label class="text-muted">Producer :</label> 
											   <label>{{u.producer_name}}</label>
						...
						<form name="proForm" id="proForm">
							...
							<div class="form-group has-feedback actor box">
								<select name="actorType" id="actorType"
									...
									ng-init="ctrlUser.userdetails.actorType='Actor'"
							...
							<div class="form-group has-feedback agency box">
								<select name="regAgency" id="regAgency"
									...
									<option value="Camera-Equipments">Camera & Equipments
									</option>
									<option value="Costume">Costume</option>
									<option value="Makeup">Makeup</option>
									<option value="Set-Department">Set Department</option>
									<option value="Acting-Direction-School">Acting/Direction
										School</option>
