...
<body ng-app="profileApp">
	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<h2>Contact Info.</h2>       
			...
			<strong>Phone:</strong>
			<ul>
			<li><p> WhatsApp Us on 9740200366 <i class="fa fa-whatsapp fa-2x" aria-hidden="true" style="color:#27c24c"></i> </p> </li>	
			...
			<strong>Website:</strong><a rel="nofollow" href="http://www.a2zcinemaworld.com/" target="_blank">  www.a2zcinemaworld.com</a><br /><br /><br /><br />
			</div>
			<div class="col-lg-3 panel panel-default">
		       <h4 class=" text-center">Send Us A Message</h4>
		             <form name="contactForm" ng-controller="EmailController as emailCtrl" 
		                       ng-submit="emailCtrl.submit();">
							<div class="form-group has-feedback">
								<input type="text" class="form-control-text" style="width: 100%;" ng-model="emailCtrl.emails.name" onChange="this.value=this.value.substring(0, 1).toUpperCase() + this.value.substring(1);"
								id="name" name="name"  placeholder="Your name..." required autocomplete="off">
							</div>
							<div class="form-group has-feedback">
								<input type="email" class="form-control-text" style="width: 100%;" ng-model="emailCtrl.emails.emailFrom"
								id="emailFrom" name="emailFrom" placeholder="Your email..." required autocomplete="off">
							</div>
							<div class="form-group has-feedback">
								<input type="text" class="form-control-text" style="width: 100%;" ng-model="emailCtrl.emails.subject" onChange="this.value=this.value.substring(0, 1).toUpperCase() + this.value.substring(1);"
								id="subject" name="subject" placeholder="Subject..." required autocomplete="off">
							</div>
							<div class="form-group has-feedback">
								<textarea id="message" class="form-control form-control-text" style="width: 100%; font-size:100%; " ng-model="emailCtrl.emails.message" style="overflow: auto; resize: none" rows="4"
								id="message" name="message" placeholder="Message..." required autocomplete="off"></textarea>
							</div>
