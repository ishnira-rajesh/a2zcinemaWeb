	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default ">
				...
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						A2zcinemaworld.com delivers a complete movie making service in a short span of time in an impressive way in reaching out to the audience. We take the ownership of producing complete movie starting from Development of movie to release of the movie to the theatres/home theatres. </br> </br>
						Movie Making Team consists of Eminent Directors, Story Writers, Screenplay writers, Dialogue writers, Cinematographers (Cameraman), Choreographers, Producers and selective public including media friends to take their opinion for the best outcome.
					</h4>
					</br>
					</br>
					<p>Note: Film production is the process of making a film. Filmmaking involves a number of discrete stages including an initial story, idea, or commission, through scriptwriting, casting, shooting, reproduction, editing, and screening the finished product before an audience that may result in a film release and exhibition. Filmmaking takes place in many places around the world in a range of economic, social, and political contexts, and using a variety of technologies and cinematic techniques. Typically, it involves a large number of people, and can take from a few months to several years to complete</p>
					</br>
					<h5>For any query, whatapp us on 9740200366 <i class="fa fa-whatsapp fa-2x" aria-hidden="true" style="color:#27c24c"></i> for immediate solutions.</h5>
				</div>
