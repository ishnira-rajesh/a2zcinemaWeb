...
angular.module('profileApp').factory('BackProfileService', ['$http', '$q', function($http, $q){
    ...
    /*var REST_SERVICE_URI_BACK = 'http://a2zcinemaworld.com/profile/';
    var REST_SERVICE_URI_BACKPROEXPDETS = 'http://a2zcinemaworld.com/userProExp/';
    var REST_SERVICE_URI_BACKADDRESS = 'http://a2zcinemaworld.com/userAddress/';*/
    var factory = {
