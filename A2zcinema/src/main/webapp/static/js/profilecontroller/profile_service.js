...
angular.module('profileApp').factory('ProfileService', ['$http', '$q', function($http, $q){
    ...
    /*var REST_SERVICE_URI = 'http://a2zcinemaworld.com/profile/';
    var REST_SERVICE_URI_PHY = 'http://a2zcinemaworld.com/physicalDetails/';
    var REST_SERVICE_URI_ADDRESS = 'http://a2zcinemaworld.com/userAddress/';
    var REST_SERVICE_URI_PROEXPDETS = 'http://a2zcinemaworld.com/userProExp/';*/
