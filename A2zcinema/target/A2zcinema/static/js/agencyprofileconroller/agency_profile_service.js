...
angular.module('profileApp').factory('AgencyProfileService', ['$http', '$q', function($http, $q){
   ...
   /* var REST_SERVICE_APINFO = 'http://a2zcinemaworld.com/agencyprofileinfo/';
    var REST_SERVICE_URI_AGNPROEXPDETS = 'http://a2zcinemaworld.com/userProExp/';
    var REST_SERVICE_URI_AGNADDRESS = 'http://a2zcinemaworld.com/userAddress/';*/
