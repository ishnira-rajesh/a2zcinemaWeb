								...
								<div class="panel panel-default">
									...
									<form name="userProfileForm" class="form-horizontal mb-lg"
										...
										<fieldset ng-if="ctrlAgency.agnpdata.length == 0">
											...
											<div class="form-group has-feedback">
												<label for="" class="text-muted col-lg-4">Services</label> <input
													...
													placeholder="Enter your Services " required maxlength="200" autocomplete="off">
											</div>
											<div class="form-group has-feedback">
										...
										<fieldset ng-if="ctrlAgency.agnpdata.length != 0"
										    ...
										    ng-model="ctrlAgency.agencyProDetails.profileDetailsAgencyId" ng-init="ctrlAgency.agencyProDetails.profileDetailsAgencyId=u.Profile_details_agency_id " />
											...
											<div class="form-group has-feedback" ng-class="{ 'has-error' : userProfileForm.mobile.$invalid && !userProfileForm.mobile.$pristine }">
												<label for="" class="text-muted col-lg-4">Mobile No</label>
												<input ng-model="ctrlAgency.agencyProDetails.mobile" ng-init="ctrlAgency.agencyProDetails.mobile=u.contact_no"
													name="mobile" class="form-control-text col-2"
													placeholder="mobile no" required maxlength="16" autocomplete="off" ng-minlength="10" ng-maxlength="15"/>
												<p ng-show="userProfileForm.mobile.$error.minlength"
									                 class="help-block">Mobile is too short minlength 10.</p>
											...
											<div class="form-group has-feedback">
												<label for="" class="text-muted col-lg-4">Email </label> <input
													type="email" ng-model="ctrlAgency.agencyProDetails.email" ng-init="ctrlAgency.agencyProDetails.email=u.email_id" name="email"
													class="form-control-text col-2" placeholder="E-mail"
													maxlength="50" autocomplete="off" required>
											</div>
											...
											<div class="form-group has-feedback">
												<label for="" class="text-muted col-lg-4">Services</label> <input
													...
													name="service" class="form-control-text col-2"
													placeholder="Enter your Services " maxlength="200" autocomplete="off" required>
											</div>
											
											<div class="form-group has-feedback">
												<label for="" class="text-muted col-lg-4">About me </label>
												<textarea ng-model="ctrlAgency.agencyProDetails.aboutme" ng-init="ctrlAgency.agencyProDetails.aboutme=u.aboutme"
													name="aboutme" placeholder="About me (optional)"
													class="form-control form-control-text col-2" maxlength="200"
													style="overflow: auto; resize: none" rows="4"
													aria-invalid="false" autocomplete="off"></textarea>
										...
										<fieldset ng-if="ctrlProExp.expdata.length ==0">
											...
											<div class="form-group has-feedback">
												<label for="" class="text-muted col-lg-6">The Film
													...
													name="preWorkInd" class="form-control-text col-2" required 
										...
										<fieldset ng-if="ctrlAdd.adddata.length == 0">
											...
											<div class="form-group has-feedback">
												...
												<input ng-model="ctrlAdd.addressdetails.prDistrict"
													...
													placeholder="District" onChange="this.value=this.value.substring(0, 1).toUpperCase() + this.value.substring(1);" maxlength="50" autocomplete="off" required>
											</div>
											...
											<div class="form-group has-feedback">
												...
												<input ng-model="ctrlAdd.addressdetails.pmDistrict"
													...
													placeholder="District" onChange="this.value=this.value.substring(0, 1).toUpperCase() + this.value.substring(1);" autocomplete="off">
											</div>
